...
const D3Map: React.FC<D3MapProps> = ({setAttackCountries}) => {
    ...
    const init = () => {
        ...
        const svg = d3.select('svg[id="map"]')
            .attr('width', '100%')
            .attr('height', '100%')
        ...
        const projection = d3.geoMercator()
            .scale(250)
            .translate([0.3 * width, 0.56 * height]);
        ...
        d3.json('https://unpkg.com/world-atlas@2.0.2/countries-110m.json').then((worldData: any) => {
            ...
            svg.selectAll('path')
                ...
                .on('mouseout', function(d) {
                    //@ts-ignore
                    d3.select(this).attr('class', d => d.id === '860' ? 'country country-target' : 'country');
                });
            ...
            const countriesPool = [
                ...
                { name: "Russia", coords: [105.3188, 61.5240] }, // Main Russia
                ...
                { name: "Iran", coords: [53.6880, 32.4279] },
                ...
                { name: "Nigeria", coords: [8.6753, 9.0820] },
                ...
                { name: "Bangladesh", coords: [90.3563, 23.6850] },
                { name: "Colombia", coords: [-74.2973, 4.5709] },
                { name: "Peru", coords: [-75.0152, -9.1900] },
                ...
                { name: "Bolivia", coords: [-64.9623, -16.5000] },
                ...
                { name: "Norway", coords: [8.4689, 60.4720] },
                ...
                { name: "Tajikistan", coords: [71.2761, 38.8610] },
                ...
                { name: "Republic of the Congo", coords: [15.8277, -0.2280] },
                ...
                { name: "Lesotho", coords: [28.8742, -29.6090] },
                { name: "Sierra Leone", coords: [-11.7799, 8.4606] },
                { name: "Liberia", coords: [-9.4295, 6.4281] },
                { name: "Ghana", coords: [-0.1860, 7.1733] },
                { name: "Ivory Coast", coords: [-5.3450, 7.5399] },
                { name: "Togo", coords: [0.8250, 8.6195] },
                { name: "Benin", coords: [2.3158, 9.3070] },
                { name: "Nigeria", coords: [8.6753, 9.0820] },
                ...
                { name: "Mauritania", coords: [-10.2049, 20.2540] },
                ...
                { name: "Micronesia", coords: [150.2150, 6.9116] },
                ...
                { name: "Fiji", coords: [178.0650, -17.7134] },
                { name: "Papua New Guinea", coords: [144.2620, -6.3159] },
                { name: "Solomon Islands", coords: [160.0000, -9.0000] },
