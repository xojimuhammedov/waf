  ...
  return (
    <div
      ...
      {(typeof rest.open === 'boolean' ? rest.open : open) && (
        <div
          className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-bg-dark-bg"
          role="menu"
